...
[Getting Started with Rails]: http://guides.rubyonrails.org/v4.2.9/getting_started.html
...
- [Rails Code (v4.2.9)] _([`rails` releases])_
- [The API Documentation (v4.2.9)]
- [Ruby on Rails Guides (v4.2.9)]

Beyond these official guides, it can be useful to read [The Beginner's
Guide to Rails Helpers].

[Rails Code (v4.2.9)]: https://github.com/rails/rails/tree/v4.2.9
[`rails` releases]: https://github.com/rails/rails/releases
[The API Documentation (v4.2.9)]: http://api.rubyonrails.org/v4.2.9/
[Ruby on Rails Guides (v4.2.9)]: http://guides.rubyonrails.org/v4.2.9/
...
- `rails` version 4.2.9 gets installed by the previous action. If
you want to start a new project at this point you should manually
install `rails` instead: `gem install rails -v 4.2.9`)
...
[Ruby on Rails Security Guide]: http://guides.rubyonrails.org/v4.2.9/security.html
...
[RailsGuide about migrations]: http://guides.rubyonrails.org/v4.2.9/active_record_migrations.html#creating-a-migration
...
["Maintaining The Test Database Schema"]: http://guides.rubyonrails.org/v4.2.9/testing.html#maintaining-the-test-database-schema

[`db:test:prepare`]: https://github.com/rails/rails/blob/v4.2.9/activerecord/lib/active_record/railties/databases.rake#L359-L364

[`railties/databases.rake`]: https://github.com/rails/rails/blob/v4.2.9/activerecord/lib/active_record/railties/databases.rake
