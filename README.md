...
[Getting Started with Rails]: http://guides.rubyonrails.org/v5.0.4/getting_started.html
...
- [Rails Code (v5.0.4)] _([`rails` releases])_
- [The API Documentation (v5.0.4)]
- [Ruby on Rails Guides (v5.0.4)]

Beyond these official guides, it can be useful to read [The Beginner's
Guide to Rails Helpers].

[Rails Code (v5.0.4)]: https://github.com/rails/rails/tree/v5.0.4
[`rails` releases]: https://github.com/rails/rails/releases
[The API Documentation (v5.0.4)]: http://api.rubyonrails.org/v5.0.4/
[Ruby on Rails Guides (v5.0.4)]: http://guides.rubyonrails.org/v5.0.4/
...
- `rails` version 5.0.4 gets installed by the previous action. If
you want to start a new project at this point you should manually
install `rails` instead: `gem install rails -v 5.0.4`)
...
[Ruby on Rails Security Guide]: http://guides.rubyonrails.org/v5.0.4/security.html
...
[RailsGuide about migrations]: http://guides.rubyonrails.org/v5.0.4/active_record_migrations.html#creating-a-migration
...
["Maintaining The Test Database Schema"]: http://guides.rubyonrails.org/v5.0.4/testing.html#maintaining-the-test-database-schema

[`db:test:prepare`]: https://github.com/rails/rails/blob/v5.0.4/activerecord/lib/active_record/railties/databases.rake#L359-L364

[`railties/databases.rake`]: https://github.com/rails/rails/blob/v5.0.4/activerecord/lib/active_record/railties/databases.rake
