...
[Getting Started with Rails]: http://guides.rubyonrails.org/v5.2.1/getting_started.html
...
- [Ruby Code (v2.5.1)] _([`ruby` releases])_
- [Ruby 2.5.1 Core Documentation]
- [Ruby 2.5.1 Standard Library Documentation]
- [Ruby Style Guide]
- [`rvm`] as the Ruby Version Manager _([`rvm` releases])_

[Ruby Code (v2.5.1)]: https://github.com/ruby/ruby/tree/v2_5_1
[`ruby` releases]: https://github.com/ruby/ruby/releases
[Ruby 2.5.1 Core Documentation]: http://ruby-doc.org/core-2.5.1/
[Ruby 2.5.1 Standard Library Documentation]: http://ruby-doc.org/stdlib-2.5.1/
...
- [Rails Code (v5.2.1)] _([`rails` releases])_
- [The API Documentation (v5.2.1)]
- [Ruby on Rails Guides (v5.2.1)]

Beyond these official guides, it can be useful to read [The Beginner's
Guide to Rails Helpers].

[Rails Code (v5.2.1)]: https://github.com/rails/rails/tree/v5.2.1
[`rails` releases]: https://github.com/rails/rails/releases
[The API Documentation (v5.2.1)]: http://api.rubyonrails.org/v5.2.1/
[Ruby on Rails Guides (v5.2.1)]: http://guides.rubyonrails.org/v5.2.1/
...
- `rails` version 5.2.1 gets installed by the previous action. If
you want to start a new project at this point you should manually
install `rails` instead: `gem install rails -v 5.2.1`)
...
[Install `ruby` version 2.5.1]: https://rvm.io/rubies/installing
...
[Ruby on Rails Security Guide]: http://guides.rubyonrails.org/v5.2.1/security.html
...
[RailsGuide about migrations]: http://guides.rubyonrails.org/v5.2.1/active_record_migrations.html#creating-a-migration
...
["Maintaining The Test Database Schema"]: http://guides.rubyonrails.org/v5.2.1/testing.html#maintaining-the-test-database-schema

[`db:test:prepare`]: https://github.com/rails/rails/blob/v5.2.1/activerecord/lib/active_record/railties/databases.rake#L359-L364

[`railties/databases.rake`]: https://github.com/rails/rails/blob/v5.2.1/activerecord/lib/active_record/railties/databases.rake
