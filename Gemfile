...
# for DB seeding)
gem 'faker',                    '1.6.3'   # https://rubygems.org/gems/faker/versions/1.6.3
                                          # https://github.com/stympy/faker/tree/v1.6.3
...
gem 'carrierwave',              '0.11.2'  # https://rubygems.org/gems/carrierwave/versions/0.11.2
                                          # https://github.com/carrierwaveuploader/carrierwave/tree/v0.11.2
...
gem 'mini_magick',              '4.5.1'   # https://rubygems.org/gems/mini_magick/versions/4.5.1
                                          # https://github.com/minimagick/minimagick/tree/v4.5.1
...
gem 'fog',                      '1.38.0'  # https://rubygems.org/gems/fog/versions/1.38.0
                                          # https://github.com/fog/fog/tree/v1.38.0
...
gem 'will_paginate',            '3.1.0'   # https://rubygems.org/gems/will_paginate/versions/3.1.0
                                          # https://github.com/mislav/will_paginate/tree/v3.1.0
                                          # https://github.com/mislav/will_paginate/releases

# Hooks into will_paginate to format the html to match Twitter Bootstrap
# styling.
gem 'bootstrap-will_paginate',  '0.0.10'  # https://rubygems.org/gems/bootstrap-will_paginate/versions/0.0.10
                                          # https://github.com/yrgoldteeth/bootstrap-will_paginate/tree/v0.0.10
...
gem 'bootstrap-sass',           '3.3.6'   # https://rubygems.org/gems/bootstrap-sass/versions/3.3.6
                                          # https://github.com/twbs/bootstrap-sass/tree/v3.3.6
                                          # https://github.com/twbs/bootstrap-sass/blob/master/CHANGELOG.md
                                          # https://github.com/twbs/bootstrap-sass/releases

# Sass adapter for the Rails asset pipeline.
gem 'sass-rails',               '5.0.4'   # https://rubygems.org/gems/sass-rails/versions/5.0.4
                                          # https://github.com/rails/sass-rails/tree/v5.0.4
...
gem 'coffee-rails',             '4.1.1'   # https://rubygems.org/gems/coffee-rails/versions/4.1.1
                                          # https://github.com/rails/coffee-rails/tree/v4.1.1
...
gem 'jquery-rails',             '4.1.1'   # https://rubygems.org/gems/jquery-rails/versions/4.1.1
...
gem 'turbolinks',               '2.5.3'   # https://rubygems.org/gems/turbolinks/versions/2.5.3
                                          # https://github.com/turbolinks/turbolinks-classic/releases

# Create JSON structures via a Builder-style DSL
gem 'jbuilder',                 '2.5.0'   # https://rubygems.org/gems/jbuilder/versions/2.5.0
                                          # https://github.com/rails/jbuilder/tree/v2.5.0
...
gem 'rails-i18n',               '4.0.8'   # https://rubygems.org/gems/rails-i18n/versions/4.0.8
...
# allows undo)
gem 'paper_trail',              '5.1.1'   # https://rubygems.org/gems/paper_trail/versions/5.1.1
                                          # https://github.com/airblade/paper_trail/tree/v5.1.1
...
group :test do
  ...
  gem 'minitest-reporters',     '1.1.9'   # https://rubygems.org/gems/minitest-reporters/versions/1.1.9
