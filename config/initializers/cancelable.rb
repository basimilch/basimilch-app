...
module Cancelable
  ...
  # DOC: http://api.rubyonrails.org/v5.2.0/classes/ActiveSupport
...
ERROR_MSG
    ...
    # DOC: http://api.rubyonrails.org/v5.2.0/classes/ActiveSupport/Callbacks
    ...
    before_destroy do
      canceled? or (
        ...
        # SOURCE: http://guides.rubyonrails.org/v5.2.0/upgrading_ruby_on_rails.html#halting-callback-chains-via-throw-abort
