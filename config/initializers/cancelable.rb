...
ERROR_MSG
    ...
    # DOC: http://api.rubyonrails.org/v5.1.4/classes/ActiveSupport/Callbacks
    ...
    before_destroy do
      canceled? or (
        ...
        # SOURCE: http://guides.rubyonrails.org/v5.1.4/upgrading_ruby_on_rails.html#halting-callback-chains-via-throw-abort
