...
module Cancelable
  ...
  # DOC: http://api.rubyonrails.org/v5.2.1/classes/ActiveSupport
...
ERROR_MSG
    ...
    # DOC: http://api.rubyonrails.org/v5.2.1/classes/ActiveSupport/Callbacks
    ...
    # DOC: http://api.rubyonrails.org/v5.2.1/classes/ActiveRecord/Callbacks.html
    ...
    before_destroy do
      canceled? or (
        ...
        # SOURCE: http://guides.rubyonrails.org/v5.2.1/upgrading_ruby_on_rails.html#halting-callback-chains-via-throw-abort
