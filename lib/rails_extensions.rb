...
module NumericFormattingUtils
  ...
  def to_s_currency(locale: I18n.locale, decimals: 2)
    # DOC: http://api.rubyonrails.org/v5.2.1/classes/ActionView/Helpers/NumberHelper.html#method-i-number_to_currency
...
class String
  ...
  def truncate_naturally(at: 50)
    # DOC: http://api.rubyonrails.org/v5.2.1/classes/String.html#method-i-truncate
...
module Memoizable
  ...
  # DOC: http://api.rubyonrails.org/v5.2.1/classes/ActiveSupport/Concern.html#method-i-append_features
...
# DOC: http://api.rubyonrails.org/v5.2.1/classes/ActiveModel/Validator.html
